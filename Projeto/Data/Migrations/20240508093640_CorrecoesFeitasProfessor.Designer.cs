...
namespace Projeto.Data.Migrations
{
    ...
    [Migration("20240508093640_CorrecoesFeitasProfessor")]
    partial class CorrecoesFeitasProfessor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projeto.Models.Categories", b =>
                {
            ...
            modelBuilder.Entity("Projeto.Models.Utilizadores", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReviewsUtilizadores", b =>
                {
                    ...
                    b.HasKey("ReviewsReviewId", "UsersUserId");

                    b.HasIndex("UsersUserId");

                    b.ToTable("ReviewsUtilizadores");
                });
            ...
            modelBuilder.Entity("Projeto.Models.Reviews", b =>
                {
                    b.HasOne("Projeto.Models.Categories", "CategoryFK")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("ReviewsUtilizadores", b =>
                {
                    b.HasOne("Projeto.Models.Reviews", null)
                        .WithMany()
                        .HasForeignKey("ReviewsReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Projeto.Models.Utilizadores", null)
                        .WithMany()
